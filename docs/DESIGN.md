...
> Design notes for **nonprofit-csv-signed-download** — a runnable python example that Python nonprofit report export that returns a signed CSV download URL.
...
- **Feature code** — the actual task: nonprofit-report-download.
